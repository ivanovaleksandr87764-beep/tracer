...
1. РЕЗУЛЬТАТ. Какой реальный результат человек хочет получить? (не задачу — а конечный результат)
2. ЦЕЛЬ. К какой стратегической цели это движет? Или это вообще не туда?
3. ПУТЬ. Тот ли путь выбран? Что если сделать наоборот / меньше / по-другому?
4. ЦЕНА. Сколько это съест времени и фокуса? Стоит ли результата?
5. РИСКИ. Что может пойти не так? Что упустим если возьмём?
6. ИТОГ. Брать / переделать / выкинуть.

В thinking напиши свой ход мысли — связно, как живой человек думает. Без буллетов. 4-6 предложений.
...
{{
  ...
  "thinking": "Связный ход мысли 4-6 предложений. Начни с РЕЗУЛЬТАТА которого хочет автор. Потом — реально ли это движет к цели. Если да — как сделать максимально эффективно. Если нет — что вместо. Конкретно, без воды.",
  "alternative": "Если видишь более эффективный путь — конкретно опиши. Например: 'Вместо контент-плана на месяц — сделай 3 поста на основе уже записанных эфиров и посмотри отклик. План на месяц устареет через неделю'. Иначе пустая строка.",
  "doubt": "Если задача дублирует существующую или вообще не нужна — напиши почему. Назови существующую задачу по НАЗВАНИЮ, не по id. Иначе пустая строка."
}}
